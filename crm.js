...
// Total Paid is intentionally a separate manual accounting field. Estimate
// Amount can flow in from an estimate, but deposits must never silently become
...
function openEstimatorInCommandCenter(url, estimateData = null) {
  ...
  estimatorUrl.searchParams.set("v", "20260913-interior-painting-warranty");
...
window.addEventListener("message", (event) => {
  ...
  if (event.data?.type === "animus-estimator-height") {
    const frame = $("crmEstimatorFrame");
